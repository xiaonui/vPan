...
For discrete values, the fisher's exact test (`fisher.test()`) will be used to determine whether the distribution of each gene is uniform. For continuous vlaues, Wilcoxon tests(`wilcox.test()`) will be performed.
